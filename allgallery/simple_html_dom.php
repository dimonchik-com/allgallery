...
class simple_html_dom_node_not_conflict {
...
// -----------------------------------------------------------------------------
class simple_html_dom_not_conflict {
    public $root = null;
    public $nodes = array();
    ...
    protected function prepare($str, $lowercase=true) {
        ...
        $this->root = new simple_html_dom_node_not_conflict($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new simple_html_dom_node_not_conflict($this);
        ++$this->cursor;
